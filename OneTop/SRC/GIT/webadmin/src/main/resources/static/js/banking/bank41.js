$(document).ready(function() {
    ...
    // 검색 버튼 이벤트
    $('#search_bank41_btn').bind('click', function () {
        console.log("search_bank41_btn click");
        $('#page').val('1');
        $('#search_bank41_form').submit();
        return false;
    });
...
$(function(){
    ...
    /** Excel D/L click */
    $("#bank41_excel_down_btn").click(function() {
        var f = document.search_bank41_form;
        ...
        post_to_url("bank41/excelDown", "_blank", params, "post");
    });
